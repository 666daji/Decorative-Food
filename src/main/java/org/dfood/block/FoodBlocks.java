...
public class FoodBlocks {
    ...
    private static Block registerFoodBlock(String id, int foodValue, AbstractBlock.Settings settings,
        ...
        RegistryKey<Block> key = RegistryKey.of(RegistryKeys.BLOCK, Identifier.ofVanilla(id));
        Block block = DFoodUtils.createFoodBlock(foodValue, settings.registryKey(key), blockCreator);
